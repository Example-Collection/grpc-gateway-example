...
func (c *userServiceClient) SaveUser(ctx context.Context, in *SaveUserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
func (UnimplementedUserServiceServer) SaveUser(context.Context, *SaveUserRequest) (*UserResponse, error) {
